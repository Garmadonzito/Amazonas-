...
public:
    ...
    void login(Inventario& inv) {
        ...
        irA(5, PANEL_COL); cout << "\033[0m            \033[96m                    LOGIN DE CLIENTE                    \033[0m";
        ...
        do {
            if (!primeraVez) {
                irA(22, PANEL_COL); cout << "\033[91m>> Error: DNI invalido. Debe tener exactamente 8 digitos numericos.\033[0m";
            }
            primeraVez = false;

            irA(14, PANEL_COL); cout << string(60, ' ');
            irA(14, PANEL_COL); cout << "\033[0mDNI: ";
            getline(cin, dni);
        ...
        if (clienteEncontrado != nullptr) {
            ...
            irA(16, PANEL_COL); cout << "\033[0mNombre: " << this->nombre << " (Cargado en memoria)";
            irA(18, PANEL_COL); cout << "\033[0mCorreo: " << this->correo << " (Cargado en memoria)";
            irA(24, PANEL_COL); cout << "\033[92m>> Bienvenido nuevamente, " << this->nombre << "! (Acceso instantaneo)\033[0m";
        }
        else {
            irA(16, PANEL_COL); cout << "\033[0mNombre nuevo: "; getline(cin, nombre);
            ...
            do {
                if (!primeraVezCorreo) {
                    irA(22, PANEL_COL); cout << "\033[91m>> Error: Formato de correo invalido.\033[0m";
                }
                primeraVezCorreo = false;

                irA(18, PANEL_COL); cout << string(60, ' ');
                irA(18, PANEL_COL); cout << "\033[0mCorreo: ";
                getline(cin, correo);
            ...
            irA(24, PANEL_COL); cout << "\033[92m>> Registro masivo exitoso. Bienvenido " << this->nombre << "!\033[0m";
        }
        pausa();
    }
    ...
    void bucleAgregarRapido(Inventario& inv, int filaInicio) {
        ...
        while (true) {
            ...
            if (p != nullptr && p->stock > 0) {
                carrito->agregar(id);
                cout << "\033[92m>> '" << p->nombre << "' agregado! Stock: " << p->stock << "          \033[0m";
            }
            else {
                cout << "\033[91m>> ID invalido o sin stock.                         \033[0m";
            }
        }
    }
    ...
    void verCarrito(Inventario& inv) {
        ...
        if (comprasRealizadas == 0 && total > 0) {
            ...
            irA(fila++, PANEL_COL); cout << "\033[93m  Descuento de bienvenida (15%) aplicado!\033[0m";
        }

        fila++;
        if (direccionEnvio.esValida()) {
            irA(fila++, PANEL_COL); cout << "\033[96mDATOS DE ENTREGA:\033[0m";
            direccionEnvio.mostrar(fila);
            fila += 4;
        }
        else {
            irA(fila++, PANEL_COL); cout << "\033[91m[!] Direccion no registrada. Se usara recojo en tienda.\033[0m";
        }
        ...
        irA(fila, PANEL_COL); cout << "\033[92m  TOTAL A PAGAR:      S/. " << (int)total << "\033[0m";
    }
    ...
    void comprarCarrito(Inventario& inv) {
        ...
        grafica.dibujarFondoSinLogo();
        comprasRealizadas++;
        irA(20, PANEL_COL); cout << "  \033[92m>> Compra procesada con exito. Gracias por preferirnos!\033[0m";
        pausaRetroceder(24);
    }
    ...
    void menuBuscarProducto(Inventario& inv) {
        ...
        while (true) {
            ...
            irA(2, PANEL_COL); cout << "\033[93m   ______ \033[92m   ___      __  ___    ___     ____   ___     _  __     ___     ____ \033[0m";
            irA(3, PANEL_COL); cout << "\033[93m  /     /|\033[92m  /   |    /  |/  /   /   |   /_  /  / _ \\   / |/ /    /   |   / __/ \033[0m";
            irA(4, PANEL_COL); cout << "\033[93m /_____/ |\033[92m / /| |   / /|_/ /   / /| |    / /  / / / / /    /    / /| |  \\__ \\ \033[0m";
            irA(5, PANEL_COL); cout << "\033[93m |     | |\033[92m / ___ |  / /  / /   / ___ |   / /_/ /_/ / / /|  /   / ___ | ___/ /  \033[0m";
            irA(6, PANEL_COL); cout << "\033[93m |_____|/ \033[92m /_/  |_| /_/  /_/   /_/  |_|  /___/ \\____/ /_/ |_/   /_/  |_|/____/  \033[0m";
            ...
            if (c == '1') {
                ...
                if (idStr.find_first_not_of("0123456789") == string::npos) {
                    ...
                    if (p != nullptr && p->stock > 0) {
                        ...
                        if (confirma == 's' || confirma == 'S') {
                            ...
                            irA(36, PANEL_COL); cout << "  \033[92m>> Agregado con exito!\033[0m";
                        }
                        else {
                            irA(36, PANEL_COL); cout << "  \033[91m>> Operacion cancelada.\033[0m";
                        }
                    }
                    else {
                        irA(34, PANEL_COL); cout << "  \033[91m>> Producto no encontrado o sin stock.\033[0m";
                    }
                }
                pausaRetroceder(39);
            }
                ...
                if (direccionEnvio.esValida()) {
                    irA(24, PANEL_COL); cout << "  \033[92m>> Direccion registrada correctamente.\033[0m";
                }
                pausaRetroceder(26);
            }
            else if (c == '5') {
                ...
                if (idStr.find_first_not_of("0123456789") == string::npos) {
                    ...
                    if (p != nullptr) {
                        ...
                        irA(19, PANEL_COL); cout << "  \033[92m>> Resena registrada. Gracias!\033[0m";
                    }
                    else {
                        irA(14, PANEL_COL); cout << "  \033[91m>> Producto no encontrado.\033[0m";
                    }
                }
                pausaRetroceder(22);
            }
                ...
                if (op2 == '1') {
                    ...
                    irA(17, PANEL_COL); cout << "  \033[92m>> Ticket abierto. Un agente lo revisara pronto.\033[0m";
                }
                else if (op2 == '2') {
                    limpiarZonaVerde();
                    grafica.dibujarFondoSinLogo();
                    ...
                    if (!validarIdentidad(nomV, correoV, dniV)) {
                        limpiarZonaVerde();
                        grafica.dibujarFondoSinLogo();
                        irA(16, PANEL_COL); cout << "  \033[91m>> Datos incorrectos. No se puede procesar el reembolso.\033[0m";
                        pausaRetroceder(19);
                    }
                    else {
                        limpiarZonaVerde();
                        ...
                        if (misCompras.empty()) {
                            irA(14, PANEL_COL); cout << "  \033[91m>> No tienes compras registradas aun.\033[0m";
                        }
                        else {
                            irA(4, PANEL_COL); cout << "\033[0m            \033[96m========================================================\033[0m";
                            ...
                            grafica.dibujarFondoSinLogo();
                            if (huboDevolucion) {
                                irA(14, PANEL_COL); cout << "  \033[92m>> Reembolso solicitado correctamente.\033[0m";
                                irA(15, PANEL_COL); cout << "  \033[92m>> Un agente revisara y confirmara cada devolucion.\033[0m";
                            }
                            else {
                                irA(14, PANEL_COL); cout << "  \033[91m>> No se selecciono ninguna compra.\033[0m";
                            }
                        }
                    }
                }
    ...
    void menuCarrito(Inventario& inv) {
        ...
        while (true) {
            ...
            irA(20, PANEL_COL); cout << "    \033[93m[ESC] Volver al Menu Principal\033[0m";
    ...
    void menu(Inventario& inv) {
        ...
        while (!historialNavegacion.estaVacia()) {
            ...
            if (pantallaActual == MENU_PRINCIPAL) {
                ...
                irA(16, PANEL_COL); cout << "\033[0m    3. Mi Presupuesto y Filtros Inteligentes";
                ...
                irA(12, PANEL_COL); cout << "\033[92m  >> Procesando opciones para S/." << presupuesto << "...\033[0m";
                pausaRetroceder(15);
                historialNavegacion.desapilar();
            }
        }
