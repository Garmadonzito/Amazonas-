...
public:
    ...
    void menu(Inventario& inv) {
        ...
        do {
            limpiarZonaVerde();
            // Menú de Vendedor altamente espaciado para aprovechar la consola 130x45
            linea(10, "========================================================");
            ...
            linea(32, "    8. Cerrar Sesion de Administrador");

            linea(35, "    Seleccione una opcion: "); cin >> op;
            ...
            if (op != 8) pausa(); // Llama a la pausa que se limpia sola de Usuario.h
