...
public:
    bool login() {
        ...
        if (pass == CODIGO_ACCESO) {
            irA(28, 44); cout << "\033[32;47m>> Acceso concedido. Cargando sistema...\033[0;42;97m";
            pausa();
            return true;
        }

        irA(28, 44); cout << "\033[31;47m>> Codigo incorrecto. Acceso denegado.\033[0;42;97m";
        pausa();
        return false;
    }
    ...
    void gestionarProductos(Inventario& inv) {
        ...
        irA(5, PANEL_COL); cout << "\033[0;42;97m\033[96m           --- REGISTRO DE NUEVO PRODUCTO ---           \033[0;42;97m";
        irA(6, PANEL_COL); cout << "\033[0;42;97m\033[96m========================================================\033[0;42;97m";

        irA(12, PANEL_COL); cout << "\033[0;42;97mID: "; cin >> id;
        if (inv.existeProducto(id)) {
            irA(14, PANEL_COL); cout << "\033[0;42;97m\033[91m>> Error: El ID ya existe en el sistema.\033[0;42;97m";
            return;
        }
        irA(14, PANEL_COL); cout << "\033[0;42;97mNombre: "; cin.ignore(); getline(cin, nombre);
        irA(16, PANEL_COL); cout << "\033[0;42;97mCategoria: "; getline(cin, categoria);
        irA(18, PANEL_COL); cout << "\033[0;42;97mPrecio: S/. "; cin >> precio;
        irA(20, PANEL_COL); cout << "\033[0;42;97mStock Inicial: "; cin >> stock;

        inv.agregarProducto(id, nombre, categoria, precio, stock);
        irA(24, PANEL_COL); cout << "\033[0;42;97m\033[92m>> Producto guardado correctamente en la lista enlazada.\033[0;42;97m";
    }
    ...
    void editarProducto(Inventario& inv) {
        ...
        int id;
        irA(4, PANEL_COL); cout << "\033[0;42;97m            \033[96m========================================================\033[0;42;97m";
        irA(5, PANEL_COL); cout << "\033[0;42;97m            \033[96m         --- MODIFICACION DE STOCK Y PRECIO ---         \033[0;42;97m";
        irA(6, PANEL_COL); cout << "\033[0;42;97m            \033[96m========================================================\033[0;42;97m";

        irA(12, PANEL_COL); cout << "\033[0;42;97mID del producto a editar: "; cin >> id;

        if (!inv.existeProducto(id)) {
            irA(14, PANEL_COL); cout << "\033[0;42;97m\033[91m>> Producto no encontrado.\033[0;42;97m";
            return;
        }

        float nPrecio;
        int nStock;
        irA(14, PANEL_COL); cout << "\033[0;42;97mNuevo Precio: S/. "; cin >> nPrecio;
        irA(16, PANEL_COL); cout << "\033[0;42;97mNuevo Stock Unidades: "; cin >> nStock;
        inv.modificarProducto(id, nPrecio, nStock);
        irA(20, PANEL_COL); cout << "\033[0;42;97m\033[92m>> Datos actualizados en el archivo binario.\033[0;42;97m";
    }
    ...
    void eliminarProducto(Inventario& inv) {
        ...
        int id;
        irA(4, PANEL_COL); cout << "\033[0;42;97m            \033[96m========================================================\033[0;42;97m";
        irA(5, PANEL_COL); cout << "\033[0;42;97m            \033[96m          --- ELIMINAR PRODUCTO DEL SISTEMA ---         \033[0;42;97m";
        irA(6, PANEL_COL); cout << "\033[0;42;97m            \033[96m========================================================\033[0;42;97m";

        irA(12, PANEL_COL); cout << "\033[0;42;97mID del producto a eliminar: "; cin >> id;

        if (inv.eliminarProducto(id)) {
            irA(15, PANEL_COL); cout << "\033[0;42;97m\033[92m>> Nodo eliminado y memoria liberada correctamente.\033[0;42;97m";
        }
        else {
            irA(15, PANEL_COL); cout << "\033[0;42;97m\033[91m>> No se pudo eliminar: ID inexistente.\033[0;42;97m";
        }
    }
    ...
    void menu(Inventario& inv) {
        ...
        do {
            ...
            dibujarMarco(4, PANEL_COL, 56, 3, "96");
            irA(5, PANEL_COL + 14); cout << "\033[96mPANEL DE CONTROL - LOGISTICA\033[0;42;97m";

            irA(13, TEXT_COL); cout << "\033[0;42;97m1. Listar Catalogo          8. Ordenar por Precio";
            irA(15, TEXT_COL); cout << "\033[0;42;97m2. Registrar Producto       9. Filtrar por Rango";
            irA(17, TEXT_COL); cout << "\033[0;42;97m3. Editar Precio/Stock     10. Valor Total Inventario";
            irA(19, TEXT_COL); cout << "\033[0;42;97m4. Eliminar Producto       11. Gestionar Cupones";
            irA(21, TEXT_COL); cout << "\033[0;42;97m5. Alertas de Stock        12. Soporte al Cliente";
            irA(23, TEXT_COL); cout << "\033[0;42;97m6. Historial de Ventas     13. Ver Resenas";
            irA(25, TEXT_COL); cout << "\033[0;42;97m7. Reporte de Almacen      14. Ver Clientes (Tabla Hash)";
            irA(27, TEXT_COL); cout << "\033[0;42;97m17. Ordenar por Precio (Quick Sort)";
            irA(29, TEXT_COL); cout << "\033[0;42;97m18. Mostrar Top Clientes   19. Generar Dataset (100 Datos)";
            irA(31, TEXT_COL); cout << "\033[0;42;97m\033[93m15. Cerrar Sesion de Administrador\033[0;42;97m";
            irA(38, 52); cout << "\033[0;42;97mSeleccione una opcion: "; cin >> op;
            ...
            case 9: {
                ...
                float minP, maxP;
                irA(12, PANEL_COL); cout << "\033[0;42;97m  Precio minimo: "; irA(12, PANEL_COL + 18); cin >> minP;
                irA(14, PANEL_COL); cout << "\033[0;42;97m  Precio maximo: "; irA(14, PANEL_COL + 18); cin >> maxP;
                limpiarZonaVerde();
                grafica.dibujarFondoSinLogo();
            ...
            case 11: {
                ...
                irA(30, PANEL_COL); cout << "\033[0;42;97m  Agregar cupon? (S/N): ";
                char r; cin >> r;
                if (r == 'S' || r == 's') {
                    string cod; float desc;
                    irA(32, PANEL_COL); cout << "\033[0;42;97m  Codigo: "; irA(32, PANEL_COL + 10); cin >> cod;
                    irA(33, PANEL_COL); cout << "\033[0;42;97m  Descuento %: "; irA(33, PANEL_COL + 14); cin >> desc;
            ...
            case 12: {
                ...
                irA(38, PANEL_COL); cout << "\033[0;42;97m  Avanzar estado de ticket? Ingrese ID (0 para no): ";
            ...
            case 19: { // OPCION UNIFICADA PARA EL DATASET
                ...
                irA(12, PANEL_COL); cout << "\033[0;42;97m  \033[93m>> Generando " << cant << " clientes aleatorios...\033[0;42;97m";
                GeneradorDatos::generarClientesAleatorios(cant, inv);

                irA(14, PANEL_COL); cout << "\033[0;42;97m  \033[93m>> Simulando " << cant << " ventas masivas...\033[0;42;97m";
                GeneradorDatos::generarVentasAleatorias(cant, inv);

                irA(16, PANEL_COL); cout << "\033[0;42;97m  \033[92m>> Dataset creado e insertado en O(1).\033[0;42;97m";
                irA(18, PANEL_COL); cout << "\033[0;42;97m  \033[96m>> Tip: Usa la opcion 14 o 18 para probar la velocidad.\033[0;42;97m";
                break;
            }
            }
