...
public:
    void pagar(double monto) {
        ...
        irA(4, col); cout << "            \033[95m========================================================\033[0;42;97m";
        irA(5, col); cout << "            \033[95m               --- PAGO CON TARJETA ---                 \033[0;42;97m";
        irA(6, col); cout << "            \033[95m========================================================\033[0;42;97m";
        ...
        irA(20, col); cout << "\033[92m>> Procesando pago de S/. " << monto << "...\033[0;42;97m";
...
public:
    void pagar(double monto) {
        ...
        irA(4, col); cout << "            \033[95m========================================================\033[0;42;97m";
        irA(5, col); cout << "            \033[95m               --- PAGO CON YAPE / PLIN ---             \033[0;42;97m";
        irA(6, col); cout << "            \033[95m========================================================\033[0;42;97m";
        ...
        for (int i = 0; i < 15; i++) {
            ...
            cout << "\033[47m\033[30m" << qr[i] << "\033[0;42;97m";
        }

        irA(filaActual + 2, col); cout << "  Numero corporativo: 987-654-321";
        irA(filaActual + 4, col); cout << "\033[92m  >> Monto a pagar: S/. " << monto << "\033[0;42;97m";
