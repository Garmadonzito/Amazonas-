...
public:
    ...
    void listarClientesRegistrados() {
        limpiarZonaVerde();
        imprimirEnPanel(4, "            \033[95m========================================================\033[0;42;97m");
        imprimirEnPanel(5, "            \033[95m              LISTADO DE CLIENTES REGISTRADOS           \033[0;42;97m");
        imprimirEnPanel(6, "            \033[95m========================================================\033[0;42;97m");
        ...
        irA(fila + 1, PANEL_COL); cout << "\033[0;42;97m  \033[93m>> Presione 'C' para ordenar alfabeticamente (Merge Sort)\033[0;42;97m";
        irA(fila + 2, PANEL_COL); cout << "\033[0;42;97m  \033[93m>> Presione cualquier otra tecla para volver al menu...\033[0;42;97m";
        ...
        if (tecla == 'c' || tecla == 'C') {
            ...
            limpiarZonaVerde();
            imprimirEnPanel(4, "            \033[95m========================================================\033[0;42;97m");
            imprimirEnPanel(5, "            \033[95m       DIRECTORIO DE CLIENTES (A-Z) - MERGE SORT        \033[0;42;97m");
            imprimirEnPanel(6, "            \033[95m========================================================\033[0;42;97m");
            ...
            irA(filaNueva + 2, PANEL_COL); cout << "\033[93m>> Presione cualquier tecla para continuar...\033[0;42;97m";
            (void)_getch();
        }
    }
    ...
    void verStockGeneral() {
        ...
        imprimirEnPanel(5, "            \033[96m                REPORTE DE STOCK GENERAL                \033[0;42;97m");
    ...
    void mostrarStockBajo(int limite) {
        limpiarZonaVerde();
        imprimirEnPanel(4, "            \033[91m========== ALERTAS DE STOCK CRITICO ==========\033[0;42;97m");
        int fila = 12;
    ...
    void listarTodo() {
        ...
        imprimirEnPanel(4, "            \033[96m========================================================\033[0;42;97m");
        imprimirEnPanel(5, "            \033[96m                  CATALOGO AMAZONAS                     \033[0;42;97m");
        imprimirEnPanel(6, "            \033[96m========================================================\033[0;42;97m");
    ...
    void asistentePresupuesto(float presupuesto) {
        ...
        imprimirEnPanel(4, "            \033[96m========================================================\033[0;42;97m");
        imprimirEnPanel(5, "            \033[96m          ASISTENTE DE PRESUPUESTO (ARBOL AVL)          \033[0;42;97m");
        imprimirEnPanel(6, "            \033[96m========================================================\033[0;42;97m");
    ...
    void ordenarConQuickSort() {
        ...
        imprimirEnPanel(4, "            \033[96m========================================================\033[0;42;97m");
        imprimirEnPanel(5, "            \033[96m       PRODUCTOS ORDENADOS POR PRECIO (QUICK SORT)      \033[0;42;97m");
        imprimirEnPanel(6, "            \033[96m========================================================\033[0;42;97m");
    ...
    void filtrarPorRangoPrecio(float minPrecio, float maxPrecio) {
        ...
        imprimirEnPanel(4, "            \033[96m========================================================\033[0;42;97m");
        imprimirEnPanel(5, "            \033[96m          PRODUCTOS FILTRADOS POR RANGO DE PRECIO       \033[0;42;97m");
        imprimirEnPanel(6, "            \033[96m========================================================\033[0;42;97m");
    ...
    void calcularTotalInventario() {
        ...
        imprimirEnPanel(4, "            \033[96m========================================================\033[0;42;97m");
        imprimirEnPanel(5, "            \033[96m            VALOR TOTAL DEL INVENTARIO                  \033[0;42;97m");
        imprimirEnPanel(6, "            \033[96m========================================================\033[0;42;97m");
    ...
    void buscarPorNombre(std::string nom) {
        Nodo<Producto>* actual = listaProductos->getCabeza();
        imprimirEnPanel(4, "            \033[96m========================================================\033[0;42;97m");
        imprimirEnPanel(5, "            \033[96m                 --- RESULTADOS ---                     \033[0;42;97m");
        imprimirEnPanel(6, "            \033[96m========================================================\033[0;42;97m");
    ...
    void mostrarRegistroVentas() {
        ...
        imprimirEnPanel(4, "    \033[96m=======================================================================\033[0;42;97m");
        imprimirEnPanel(5, "    \033[96m                 HISTORIAL DE VENTAS (LOGISTICA)                       \033[0;42;97m");
        imprimirEnPanel(6, "    \033[96m=======================================================================\033[0;42;97m");
    ...
    void mostrarHistorialClientePersonalizado(std::string dni) {
        ...
        limpiarZonaVerde();
        imprimirEnPanel(4, "            \033[93m========================================================\033[0;42;97m");
        imprimirEnPanel(5, "            \033[93m        MIS COMPRAS (ORDENADAS POR MONTO)               \033[0;42;97m");
        imprimirEnPanel(6, "            \033[93m========================================================\033[0;42;97m");
    ...
    void mostrarTopClientesAVL() {
        ...
        irA(4, PANEL_COL); cout << "            \033[95m========================================================\033[0;42;97m";
        irA(5, PANEL_COL); cout << "            \033[95m          TOP CLIENTES FRECUENTES (ARBOL AVL)           \033[0;42;97m";
        irA(6, PANEL_COL); cout << "            \033[95m========================================================\033[0;42;97m";

        if (registroVentas == nullptr || registroVentas->estaVacia()) {
            irA(12, PANEL_COL); cout << "  \033[91m>> No hay ventas registradas en el sistema.\033[0;42;97m";
            return;
        }
        ...
        arbolReporte.recorrerInordenInverso([&filaDibujo](ClienteFrecuente cf) {
            if (filaDibujo < 36) {
                ...
                cout << "  \033[92m[" << cf.cantidadCompras << " unds]\033[0;42;97m "
        ...
        cout << "\033[96m>> Reporte generado exitosamente mediante Arbol AVL balanceado.\033[0;42;97m";
    }
    ...
    void mostrarInvResenasHeap() {
        ...
        limpiarZonaVerde();
        imprimirEnPanel(4, "            \033[96m========================================================\033[0;42;97m");
        imprimirEnPanel(5, "            \033[96m         TOP PRODUCTOS POR REPUTACION (HEAP SORT)       \033[0;42;97m");
        imprimirEnPanel(6, "            \033[96m========================================================\033[0;42;97m");
        ...
        for (int i = n - 1; i >= 0; i--) {
            ...
            string estrellas = (prom > 0) ? " [" + std::to_string(prom).substr(0, 3) + " \033[93m*\033[0;42;97m]" : " [Sin resenas]";
        ...
        fila++;
        imprimirEnPanel(fila, "\033[92m>> Catalogo de reputacion ordenado mediante Max-Heap de manera exitosa.\033[0;42;97m");
    }
